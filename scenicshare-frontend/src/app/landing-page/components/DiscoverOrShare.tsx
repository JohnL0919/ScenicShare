...
export default function DiscoverOrShare() {
  ...
  return (
    <div className="relative">
      {/* Top gradient fade - improved to be more subtle */}
      <div className="absolute top-0 left-0 w-full h-32 bg-gradient-to-b from-transparent to-bg-black/50 z-0"></div>

      {/* Main content with background */}
      <div className="bg-black/50 text-white py-12 mt-16 relative z-10">
